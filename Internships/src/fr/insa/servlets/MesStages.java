...
@WebServlet("/mes-stages")
public class MesStages extends HttpServlet {
	public static final String VUE = "/WEB-INF/mes-stages.jsp";

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Stage> liste = new ArrayList<Stage>();
		
		Stage st1 = new Stage();
		st1.setTitre("Airbus - D�veloppement d'un syst�me de catapulte pour humains");
		st1.setDebut(new Date(2016));
		st1.setDescription("Elon Musk en avait parl� en soir�e.");
		st1.setDuree(6);
		st1.setLieu("Lyon");
		//st1.setEntreprise(0);
		liste.add(st1);
