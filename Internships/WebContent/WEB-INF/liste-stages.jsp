...
<table class="table table-hover">
  <tbody>
    ...
    <tr>
      <td id="nonlu" class="info">
	  </td>
      <td id="logo"><img src="http://logok.org/wp-content/uploads/2014/09/Airbus-Logo-2006.png" class="img-responsive"/></td>

      <td id="description" class="vert-align">
        <h3 class="list-group-item-heading"><a href="details">Airbus - Développement d'un système de catapulte pour humains</a></h3>
    ...
    <tr>
      ...
      <td id="logo"><img src="http://logodatabases.com/wp-content/uploads/2012/07/thales-logo.jpg" class="img-responsive"/></td>

      <td id="description">
        <h3 class="list-group-item-heading"><a href="details">Thales - Evaluation de textes rédigés par un réseau de neurones, suivant la théorie de Cuil</a></h3>
    ...
    <tr>
      <td id="nonlu" class=""></td>
      <td id="logo"><img src="https://www.seeklogo.net/wp-content/uploads/2014/12/twitter-logo-vector-download.jpg" class="img-responsive"/></td>

      <td id="description">
        <h3 class="list-group-item-heading"><a href="details">Twitter - Développement d'un système tweetant directement les pensées</a></h3>
